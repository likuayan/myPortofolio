        ...
        <footer className="bg-slate-800 text-white lg:px-48  px-4 py-20">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="mb-4 md:mb-0">
                    <span className="text-3xl font-semibold text-fuchsia-800 py-2 uppercase">frontend</span>
                ...
                <div className="mb-4 md:mb-0">
                    ...
                    <p className="text-[16px] my-4">Email: s22110381@student.unklab.ac.id</p>
                    <p className="text-[16px] my-4">Phone: +64 853-9430-7959</p>
                </div>
               <div>
